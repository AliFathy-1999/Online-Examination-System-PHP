	...
	<div class="container w">
		...
		<div style="clear:both"></div>
			...
			<div class="col-sm-4" style="margin-bottom:10px;">
				<div><img src="assets/img/side1.jpg"></div>
				<?php 
				$Timer = strtotime("2021-06-01 01:00:00+0400"); 
				$secondsLeft = $Timer - time();
				$days = floor($secondsLeft / (606024)); 
				$hours = floor(($secondsLeft - ($days606024)) / (6060));
				
				echo '<center><span style=" color:#FDE9CC; border: 2px solid #4A4B7B;background-color:#4A4B7B;padding: 5px 5px 5px 5px;" >' .$days." Days : ".$hours." Hours ". '</span></center>' ?>
			</div>
		</div>
	</div>
